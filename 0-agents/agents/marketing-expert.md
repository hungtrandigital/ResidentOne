...
- Own go-to-market.md → channels/ → performance/
...
**Input Sources:**
- `2-product-foundation/2.1-product-overview.md` - Product overview, personas, pricing
- `shared/assets/brand-guidelines/` - Brand guidelines from Creative Director
...
- `4-marketing/copy/[campaign]/[copy-name].md` (e.g., `launch-hero-v3.md`)
- `4-marketing/performance/[report-name].md` (e.g., `2025-week-50.md`)
- `4-marketing/creatives/[campaign]/[creative-name]` (e.g., `ph-launch-post.md`)
...
- **[Product Overview](../../2-product-foundation/2.1-product-overview.md)** - Product positioning and features
