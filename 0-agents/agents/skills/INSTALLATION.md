...
pip install -r 0-agents/agents/skills/ai-multimodal/scripts/requirements.txt
...
```bash
cd 0-agents/agents/skills/ai-multimodal/scripts
...
**ai-multimodal** (`0-agents/agents/skills/ai-multimodal/scripts/requirements.txt`):
...
```bash
cd 0-agents/agents/skills/{skill-name}/scripts
...
2. **`0-agents/agents/skills/{skill-name}/.env`** (skill-specific config)
...
```bash
chmod +x 0-agents/agents/skills/*/scripts/*.py
```
...
# Run all tests
pytest 0-agents/agents/skills/*/scripts/tests/ -v

# Check coverage across all skills
pytest 0-agents/agents/skills/*/scripts/tests/ --cov=0-agents/agents/skills --cov-report=html
```
