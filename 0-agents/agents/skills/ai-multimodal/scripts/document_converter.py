...
def find_api_key() -> Optional[str]:
    ...
    2. 0-agents/agents/skills/ai-multimodal/.env (skill-specific config)
    ...
    if load_dotenv:
        ...
        skill_dir = script_dir.parent  # 0-agents/agents/skills/ai-multimodal
        skills_dir = skill_dir.parent   # 0-agents/agents/skills
        project_root = skills_dir.parent.parent.parent  # project root
...
def find_project_root() -> Path:
    ...
    # Look for .git directory (project root)
