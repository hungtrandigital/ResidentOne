...
def find_api_key() -> Optional[str]:
    ...
    2. PROJECT/0-agents/agents/skills/ai-multimodal/.env (skill-specific)
    3. PROJECT/0-agents/agents/skills/.env (shared skills)
    4. PROJECT/.env (project root)
...
def batch_process(
    ...
    if not api_key:
        ...
        print("4. Create .env: cd 0-agents/agents/skills/ai-multimodal && cp .env.example .env")
        sys.exit(1)
