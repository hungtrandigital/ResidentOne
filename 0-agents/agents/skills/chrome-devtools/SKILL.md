...
cd 0-agents/agents/skills/chrome-devtools/scripts
...
All scripts are in `0-agents/agents/skills/chrome-devtools/scripts/`
...
2. Verify in `0-agents/agents/skills/chrome-devtools/scripts/` directory
