...
3. **0-agents/agents/skills/.env file** (shared across all Gemini skills)
   ```bash
   echo 'GEMINI_API_KEY=your-api-key' > 0-agents/agents/skills/.env
   ```

4. **Skill directory `.env` file**
   ```bash
   echo 'GEMINI_API_KEY=your-api-key' > 0-agents/agents/skills/your-skill/.env
   ```
