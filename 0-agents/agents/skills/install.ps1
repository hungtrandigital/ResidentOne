...
function Show-Usage {
    ...
    Write-Host "  .\0-agents\agents\skills\.venv\Scripts\Activate.ps1"
    Write-Host ""
    ...
    Write-Host "  .\0-agents\agents\skills\.venv\Scripts\Activate.ps1"
    Write-Host "  cd 0-agents\agents\skills\<skill-name>\scripts"
    ...
    Write-Host "  0-agents\agents\skills\INSTALLATION.md"
    Write-Host ""
}
