...
print_usage() {
    ...
    echo -e "  source 0-agents/agents/skills/.venv/bin/activate"
    echo ""
    ...
    echo -e "  source 0-agents/agents/skills/.venv/bin/activate"
    echo -e "  cd 0-agents/agents/skills/<skill-name>/scripts"
    echo -e "  pytest tests/ -v"
    echo ""
    echo -e "${GREEN}Environment variables:${NC}"
    echo -e "  Create 0-agents/agents/skills/.env for shared config"
    echo -e "  Create 0-agents/agents/skills/<skill-name>/.env for skill-specific config"
    echo ""
    echo -e "${BLUE}For more information, see:${NC}"
    echo -e "  0-agents/agents/skills/INSTALLATION.md"
    echo ""
}
