...
class EnvLoader:
    ...
    def load_env_files() -> Dict[str, str]:
        ...
        Order: process.env > skill/.env > skills/.env > .env (project root)
        ...
        # Go up from repomix/scripts to project root: ../../../
        project_root = script_dir.parent.parent.parent.parent.parent
        search_paths = [
            project_root / ".env",                      # .env (project root)
            script_dir.parent.parent / ".env",         # skills/.env (0-agents/agents/skills/.env)
