...
class EnvLoader:
    ...
    def get_env_paths(skill_dir: Path) -> List[Path]:
        ...
        # .env (project root) - go up from skill_dir to project root
        # skill_dir is at 0-agents/agents/skills/shopify
        # Need to go up: shopify -> skills -> agents -> 0-agents -> project root
        project_root_env = skill_dir.parent.parent.parent.parent / '.env'
        if project_root_env.exists():
            paths.append(project_root_env)
