...
- **Referenced scripts**:
  ...
  - Make sure scripts respect `.env` file follow this order: `process.env` > `0-agents/agents/skills/${SKILL}/.env` > `0-agents/agents/skills/.env` > `.env` (project root) 
...
- Make sure scripts respect `.env` file follow this order: `process.env` > `0-agents/agents/skills/docs-seeker/.env` > `0-agents/agents/skills/.env` > `.env` (project root)
...
- [Agent Skills Spec](0-agents/agents/skills/agent_skills_spec.md)
