...
### 8. [Deliver Mode](deliver.md)
**Purpose:** Autonomous full task delivery - end-to-end execution without human intervention  
**When:** Complete task delivery, following plans/guides, autonomous execution until 100% complete  
...
- **Chat → Deliver:** When user requests full autonomous delivery of a task
- **Deliver → (orchestrates):** Automatically orchestrates Plan, Execution, Code, Review, Fix modes as needed
- **Deliver → Chat:** When delivery is 100% complete
...
- See individual mode documentation for specific rules:
  ...
  - [Deliver Mode Rules](deliver.md#allowed-actions) - Autonomous full delivery
...
```markdown
**Current mode**: [chat|ideas|plan|execution|code|review|fix|boost|deliver]
```
...
| **Code** | Code, tests, infrastructure, technical docs | `systems/[system-name]/`, `3-technical/3.3-devops/` | Fullstack Engineer, DevOps |
| **Review** | Code review, QA, retrospectives | Review reports, `8-governance/` | Code Reviewer, Creative Director, Docs Guardian |
| **Fix** | Bug fixes, issue resolution, problem-solving | `systems/[system-name]/`, changelog | Fullstack Engineer |
| **Boost** | Project initialization, structure setup (one-time) | Complete directory structure, migrated files | Boost Agent |
| **Deliver** | Autonomous full task delivery | Varies by task (code, designs, docs, etc.) | Orchestrates all agents |
