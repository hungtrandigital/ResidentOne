...
**📋 [Comprehensive Market Research Report](reports/comprehensive-market-research-2025-12.md)** - **START HERE**

This is the consolidated master report covering all aspects of market research:
...
- Operational model
- Project & product naming strategy
- Risks & mitigation
- Research gaps & next steps

## Contents

- **[reports/](reports/)** - Market research reports and analysis documents
- **[summaries.md](summaries.md)** - Research summaries and key findings
- **[templates/](templates/)** - Research templates and frameworks (if exists)
- **[resources/](resources/)** - External resources, links, and references (if exists)

## Report Structure

### Master Report
- **comprehensive-market-research-2025-12.md** - Consolidated master report (all research in one place)
...
### Archived Reports
- **ARCHIVED-REPORTS.md** - List of archived reports (consolidated into master report)

## Purpose

Store all market research activities:
...
- Use kebab-case: `competitor-analysis-2025-12.md`
- Include dates: `market-trends-2025-12-12.md`
- Be descriptive: `user-interviews-ecommerce.md`
